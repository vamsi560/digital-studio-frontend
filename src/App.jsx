...
const PrototypeView = ({ onNavigate }) => {
    ...
    const handleFigmaImport = async () => {
        ...
        try {
            const response = await fetch('https://digital-studio-backend.vercel.app/api/import-figma', {
                method: 'POST',
    ...
    const handleGenerateCode = async () => {
        ...
        try {
            ...
            const response = await fetch('https://digital-studio-backend.vercel.app/api/generate-code', {
                method: 'POST',
                body: formData,
            });
